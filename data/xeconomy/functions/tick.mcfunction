...
execute as @a[scores={deposit=1..}] at @s run tellraw @s ["",{"text":"Você depositou $","color":"green"},{"score":{"name":"@s","objective":"deposit"},"color":"green"},{"text":" na loja","color":"green"}]
...
execute as @a[scores={setpayxid=1..}] run tellraw @s ["",{"text":"Procurando player com esse xID "},{"score":{"name":"@s","objective":"setpayxid"},"color":"gold"},{"text":"..."}]
...
execute as @a at @s if score @s xid = xid searchx run tellraw @a[scores={setpayxid=1..}] ["",{"text":"Pagamento selecionado para o player com o xID "},{"score":{"name":"xid","objective":"searchx"},"color":"gold"},{"text":": "},{"selector":"@s"}]
execute unless score xidr searchx matches 1 run tellraw @p[scores={setpayxid=1..}] ["",{"text":"Não há player com esse xID "},{"score":{"name":"xid","objective":"searchx"},"color":"gold"},{"text":"."}]
...
execute as @a[scores={getxid=1..}] run tellraw @s ["",{"text":"Seu xID é "},{"score":{"name":"@s","objective":"xid"},"color":"gold"}]
execute as @a[scores={getxid=1..}] run scoreboard players reset @s getxid

execute as @a[scores={payxid=1..}] run tellraw @s ["",{"text":"Você enviou $","color":"green"},{"score":{"name":"@s","objective":" payxid"},"color":"green"},{"text":" para xID ","color":"green"},{"score":{"name":"@s","objective":"selectedxid"},"color":"gold"},{"text":".","color":"green"}]
...
execute as @e[scores={paynearest=1..}] at @s run tellraw @p[tag=xrecieve] ["",{"text":"Você recebeu $","color":"green"},{"score":{"name":"@s","objective":"paynearest"},"color":"green"},{"text":" de ","color":"green"},{"selector":"@s"}]
execute as @e[scores={paynearest=1..}] at @s run tellraw @s ["",{"text":"Você pagou $","color":"green"},{"score":{"name":"@s","objective":"paynearest"},"color":"green"},{"text":" para ","color":"green"},{"selector":"@p[tag=xrecieve]"}]
...
execute as @a[scores={payxid=1..}] run tellraw @s ["",{"text":"Procurando player com esse xID "},{"score":{"name":"@s","objective":"selectedxid"},"color":"gold"},{"text":"..."}]
...
execute as @a at @s if score @s xid = xid searchx run tellraw @a[scores={payxid=1..}] ["",{"text":"Você pagou $","color":"green"},{"score":{"name":"@p[scores={payxid=1..}]","objective":"payxid"},"color":"green"},{"text":" para ","color":"green"},{"selector":"@s"}]
execute as @a at @s if score @s xid = xid searchx run tellraw @s ["",{"text":"Você recebeu $","color":"green"},{"score":{"name":"@p[scores={payxid=1..}]","objective":"payxid"},"color":"green"},{"text":" de ","color":"green"},{"selector":"@p[scores={payxid=1..}]"}]
...
execute unless score xidr searchx matches 1 run tellraw @p[scores={setpayxid=1..}] ["",{"text":"Não há player online com esse xID "},{"score":{"name":"xid","objective":"searchx"},"color":"gold"},{"text":"."}]
...
execute as @e[tag=showbal] at @s run title @s actionbar ["",{"text":"Saldo: $","bold":false,"italic":false,"color":"dark_green"},{"score":{"name":"@s ","objective":"balance"},"bold":false,"italic":false,"color":"dark_green"}]
execute as @e[x_rotation=..89,tag=showbal] run title @s actionbar {"text":""}
execute as @e[x_rotation=..89] run tag @s remove showbal
execute as @e[scores={bal=1..}] at @s run tellraw @s ["",{"text":"Saldo: $","bold":false,"italic":false,"color":"green"},{"score":{"name":"@s ","objective":"balance"},"bold":false,"italic":false,"color":"green"}]
...
execute as @e[tag=xecshop,scores={b1=1}] run tellraw @p[scores={b1=1}] ["",{"text":"O preço agora é "},{"text":"$","color":"green"},{"score":{"name":"@s","objective":"shopprice"},"color":"green"}]
execute as @e[tag=xecshop,scores={b2=1}] run scoreboard players add @s shopprice 10
execute as @e[tag=xecshop,scores={b2=1}] run tellraw @p[scores={b2=1}] ["",{"text":"O preço agora é "},{"text":"$","color":"green"},{"score":{"name":"@s","objective":"shopprice"},"color":"green"}]
execute as @e[tag=xecshop,scores={b3=1}] run scoreboard players add @s shopprice 100
execute as @e[tag=xecshop,scores={b3=1}] run tellraw @p[scores={b3=1}] ["",{"text":"O preço agora é "},{"text":"$","color":"green"},{"score":{"name":"@s","objective":"shopprice"},"color":"green"}]
execute as @e[tag=xecshop,scores={b4=1}] run scoreboard players remove @s shopprice 1
execute as @e[tag=xecshop] at @s unless score @s shopprice matches 0..99999999 run scoreboard players set @s shopprice 0
execute as @e[tag=xecshop,scores={b4=1}] run tellraw @p[scores={b4=1}] ["",{"text":"O preço agora é "},{"text":"$","color":"green"},{"score":{"name":"@s","objective":"shopprice"},"color":"green"}]
execute as @e[tag=xecshop,scores={b5=1}] run scoreboard players remove @s shopprice 10
execute as @e[tag=xecshop] at @s unless score @s shopprice matches 0..99999999 run scoreboard players set @s shopprice 0
execute as @e[tag=xecshop,scores={b5=1}] run tellraw @p[scores={b5=1}] ["",{"text":"O preço agora é "},{"text":"$","color":"green"},{"score":{"name":"@s","objective":"shopprice"},"color":"green"}]
execute as @e[tag=xecshop,scores={b6=1}] run scoreboard players remove @s shopprice 100
execute as @e[tag=xecshop] at @s unless score @s shopprice matches 0..99999999 run scoreboard players set @s shopprice 0
execute as @e[tag=xecshop,scores={b6=1}] run tellraw @p[scores={b6=1}] ["",{"text":"O preço agora é "},{"text":"$","color":"green"},{"score":{"name":"@s","objective":"shopprice"},"color":"green"}]
...
execute as @e[tag=xtrigger,tag=sellx,tag=check1] at @s if score @s availslot matches 27 run tellraw @p[tag=xshopper] {"text":"A loja está cheia!","color":"red"}
execute as @e[tag=xtrigger,tag=sellx,tag=check1] at @s unless score @p[tag=xshopper] checkcount >= @s shopcount run tellraw @p[tag=xshopper] {"text":"Você não tem itens suficientes em sua mão!","color":"red"}
execute as @e[tag=xtrigger,tag=sellx,tag=check2] at @s if score @s shopmoney >= @s shopprice run tag @s add check3
execute as @e[tag=xtrigger,tag=sellx,tag=check2] at @s unless score @s shopmoney >= @s shopprice run tellraw @p[tag=xshopper] {"text":"Está loja não pode comprar de você!","color":"red"}
...
execute as @e[tag=xtrigger,tag=sellx,tag=check3] at @s run tellraw @p[tag=xshopper] ["",{"text":"$","color":"green"},{"score":{"name":"@s","objective":"shopprice"},"color":"green"},{"text":" foi adicionado em sua conta.","color":"green"}]
...
execute as @e[tag=xtrigger,tag=buyx,tag=xremoveevent] at @s run tellraw @p[tag=xshopper] ["",{"text":"$","color":"green"},{"score":{"name":"@s","objective":"shopprice"},"color":"green"},{"text":" foi removido da sua conta.","color":"green"}]
...
execute as @e[tag=buyx,scores={xbuyremove=1..}] at @s store result block ^ ^ ^-1 Items[9].Count byte 1 run scoreboard players get @s invcheck3
execute as @e[tag=buyx,scores={xbuyremove=1..}] at @s run scoreboard players remove @s xbuyremove 1
execute as @e[scores={xbshopearn=1..}] at @s if score @p xid = @s ownerid run tellraw @p ["",{"text":"$","color":"green"},{"score":{"name":"@s","objective":"xbshopearn"},"color":"green"},{"text":" foi adicionado em sua conta (pela loja).","color":"green"}]
...
execute as @e[scores={xbshopearn=1..}] at @s run execute if score @p[tag=transcheck] xid = @s ownerid run tellraw @p[tag=transcheck] ["",{"text":"$","color":"green"},{"score":{"name":"@s","objective":"xbshopearn"},"color":"green"},{"text":" foi adicionado em sua conta (pela loja).","color":"green"}]
...
execute as @e[tag=sendinfo] at @s run execute as @e[tag=xtracer] at @s if entity @e[tag=buyx,distance=..0.5] run title @p[tag=sendinfo] actionbar ["",{"text":"["},{"text":"xEconomy Shop","color":"gold"},{"text":"] ","color":"none"},{"text":"Clique com o botão direito para comprar ","color":"dark_green"},{"score":{"name":"@e[tag=xecshop,distance=..1,sort=nearest,limit=1]","objective":"shopcount"},"color":"blue"},{"text":" item(s) for ","color":"dark_green"},{"text":"$","color":"blue"},{"score":{"name":"@e[tag=xecshop,distance=..1,sort=nearest,limit=1]","objective":"shopprice"},"color":"blue"}]
execute as @e[tag=sendinfo] at @s run execute as @e[tag=xtracer] at @s if entity @e[tag=sellx,distance=..0.5] run title @p[tag=sendinfo] actionbar ["",{"text":"["},{"text":"xEconomy Shop","color":"gold"},{"text":"] ","color":"none"},{"text":"Clique com o botão direito para vender ","color":"dark_green"},{"score":{"name":"@e[tag=xecshop,distance=..1,sort=nearest,limit=1]","objective":"shopcount"},"color":"blue"},{"text":" item(s) for ","color":"dark_green"},{"text":"$","color":"blue"},{"score":{"name":"@e[tag=xecshop,distance=..1,sort=nearest,limit=1]","objective":"shopprice"},"color":"blue"}]
